/**
 * Credits: (Dan Shiffman) https://github.com/CodingTrain/Toy-Neural-Network-JS/blob/master/lib/matrix.js
 */
...
class Matrix {
  ...
  static crossover(a, b, ratio = 0.5) {
    // copied from: https://github.com/CodingTrain/Toy-Neural-Network-JS/pull/100
    if (
      !a instanceof this ||
      !b instanceof this ||
      a.rows !== b.rows ||
