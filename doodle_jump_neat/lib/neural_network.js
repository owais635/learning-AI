/**
 * Neural Network using basic matrices.
 *
 * Credits: (Dan Shiffman) https://github.com/CodingTrain/Toy-Neural-Network-JS/blob/master/lib/nn.js
 */
...
class NeuralNetwork {
  ...
  static crossover(a, b, ratio = 0.5) {
    if (
      !a instanceof this ||
      !b instanceof this ||
      a.input_nodes !== b.input_nodes ||
      a.hidden_nodes !== b.hidden_nodes ||
      a.output_nodes !== b.output_nodes
    ) {
      console.error(
        "Only NeuralNetworks of the same breed can generate offspring."
      );
      return;
    }
